  ...
  return (
    <div>
      ...
      <p>
        ...
        Möglichkeit, den Teig nach Belieben zu gestalten, verstärkt die
        Faszination für dieses Gericht. Eine der großartigen Eigenschaften von
        Pizza ist die unglaubliche Vielzahl an Belägen, die eine schier endlose
        Fülle an Geschmackskombinationen bieten. Von der klassischen Margherita
        mit saftigen Tomaten, aromatischem Basilikum und einer Schicht aus
